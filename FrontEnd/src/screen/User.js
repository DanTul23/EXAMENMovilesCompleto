...
const User = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch('http://192.168.100.30:3000/nombres')
    ...
    const deleteUser = async (item) => {
        try {
            const response = await fetch(`http://192.168.100.30:3000/nombres/${item.id}`, {
                method: 'DELETE'
            })
    ...
    const editUser = async () => {
        try {
            const response = await fetch(`http://192.168.100.30:3000/nombres/${selectedUser.id}`, {
                method: 'PUT',
                headers: {
